### This code was originally written by Daniel Gouldsbrough
### for his MSc thesis "Computing Quasiperiodic Patterns in Python"
### https://pcwww.liv.ac.uk/~hemraj/thesis/BSc/2021_Daniel_Gouldsbrough_BSc_Thesis.pdf

# The code from the thesis has a few small typos in the deflation 
# functions for P1 which have been corrected here.
# in particular: sqrt(5 + 2*sqrt(5))/2 
# was written as sqrt(5 + 2+sqrt(5))/2

# as well as substituting     v = A + E - l
# for     v = A + E - i in the diamond deflation 
# and ('diamond', i, s, v, t)  (l->i)
...
def plotOutline(tiles):
    # Marks a black line around the outline of each tile
    for tile in tiles:
...
tilingType = 'P1' # penrose tiling type P1
initialTile = pent1
N = 5
fillType = 'fill'
...
all_tiles = []
for tile in deflateGeneral(initialTile, N):
    all_tiles.append(tile[1:])