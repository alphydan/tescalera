"""Render every Manim scene from animations2.ipynb, in notebook order, as one video."""
...
NOTEBOOK = HERE / "animations2.ipynb"
OUT_DIR = HERE / "videos_finales"
FINAL_VIDEO = OUT_DIR / "tramo2.mp4"


def scene_classes_from_notebook(path: Path) -> list[type[Scene]]:
    nb = json.loads(path.read_text())
    namespace: dict = {"__name__": "tramo2_scenes"}
